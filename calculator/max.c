...
float fn_avrage(int arr[], int n)
{
   ...
   void checker(int num)
   {
      ...
      //for min
      else if(num == 2) // if the user choose 2
      {
            printf("give the numbers\n\n");
         printf("you must exactly enter 5 numbers\n");
         while(i < 5)
      ...
      else if (num == 3)
      {
          ...
          printf("loading...\n");
          printf("the min value is %.2f =>", fn_avrage(tab, i));
      }
   ...
   void menu(void)
   {
      int num;// for checking which operation the user wants
